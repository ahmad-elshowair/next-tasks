		...
		<aside className="flex h-full flex-col px-3 py-4 md:px-2">
			...
			<div className="flex grow flex-row justify-between space-x-2 md:flex-col md:space-x-0 md:space-y-2">
				...
				{!session.logged ? (
					<Link
						href={"/login"}
						className="flex h-[48px] w-full grow items-center justify-center gap-2 rounded-md bg-gray-50 p-3 text-sm font-semibold hover:bg-green-100 hover:text-neutral-600 md:flex-none md:justify-start md:p-2 md:px-3 shadow">
						<GoSignIn className="w-6 font-bold" />
